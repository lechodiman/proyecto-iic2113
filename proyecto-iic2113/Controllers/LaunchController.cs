...
namespace proyecto_iic2113.Controllers
{
    public class LaunchController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            ViewBag.isUserAttendingEvent = user != null ? await attendanceHelper.IsUserAttendingEvent(user, launch) : false;
        ...
        public async Task<IActionResult> Create([Bind("IsAllYouCanEat,Id,Name,StartDate,EndDate,Description,ConferenceId,Capacity,RoomId")] Launch launch)
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IsAllYouCanEat,Id,Name,StartDate,EndDate,Description,ConferenceId,Capacity")] Launch launch)
        {
            if (id != launch.Id)
            {
                return NotFound();
