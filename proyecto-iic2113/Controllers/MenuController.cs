...
namespace proyecto_iic2113.Controllers
{
    public class MenuController : Controller
    {
        ...
        {
            ViewData["LaunchId"] = new SelectList(_context.Set<Launch>(), "Id", "Discriminator");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FoodName,IsVegan,LaunchId")] Menu menu)
        {
            ...
            ViewData["LaunchId"] = new SelectList(_context.Set<Launch>(), "Id", "Discriminator", menu.LaunchId);
            return View(menu);
        }
